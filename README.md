...
SmartDoc is a command-line interface (CLI) tool for analyzing OpenAPI Specification (OAS) files. 

It surfaces missing details, structural issues, and inconsistencies that make APIs harder to understand and use. SmartDoc helps teams catch documentation issues early in the development process, improving API quality and the developer experience.
...
Visit the [documentation](https://smartdoc-cli.netlify.app) for instructions on installing and using SmartDoc.
